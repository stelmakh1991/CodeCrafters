      ...
      <div class="book-modal-thumb" data-id="${s.list_name}">
       <div class="book-modal-thumb768">
        ...
        <div class="book-modal-icon">
          ...
          <a href="${s.buy_links[1].url}" target="_blank" class="book-modal-link-apple"><img class="book-modal-icon-apple" src="${w}"/></a>  
        </div>
        </div>
       </div>
